...
### [HazARG](https://github.com/NazifaMoumi/HazARG)
Hazard scoring pipeline for antimicrobial resistance genes using genomic context and database-derived biological signals.
...
### [HALO](https://github.com/NazifaMoumi/HALO)
Hybrid attention-based model for protein subcellular localization using sequence embeddings, structural features, and graph-based learning.
...
Reference-guided metagenomic assembly pipeline.

### [MetaCarvel](https://github.com/marbl/metacarvel)
Metagenomic scaffolding tool for improving assemblies using graph-based information.
